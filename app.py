...
def show_menu(phone, session):
    session["stage"] = "menu"
    message = (
        "Здравствуйте! 👋 Я Анна, финансовый консультант компании DVAG. "
        "Уже 50 лет мы помогаем семьям в Германии грамотно управлять деньгами.\n\n"
        "🎁 Запишитесь на бесплатную консультацию — подберём индивидуальный финансовый план.\n\n"
        "Выберите действие:\n\n"
